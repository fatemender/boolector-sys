...
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_MIN: BtorOptSatEngine = 0;
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_LINGELING: BtorOptSatEngine = 1;
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_PICOSAT: BtorOptSatEngine = 2;
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_MINISAT: BtorOptSatEngine = 3;
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_CADICAL: BtorOptSatEngine = 4;
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_CMS: BtorOptSatEngine = 5;
pub const BtorOptSatEngine_BTOR_SAT_ENGINE_MAX: BtorOptSatEngine = 6;
pub type BtorOptSatEngine = u32;
pub const BtorOptEngine_BTOR_ENGINE_MIN: BtorOptEngine = 0;
pub const BtorOptEngine_BTOR_ENGINE_FUN: BtorOptEngine = 1;
pub const BtorOptEngine_BTOR_ENGINE_SLS: BtorOptEngine = 2;
pub const BtorOptEngine_BTOR_ENGINE_PROP: BtorOptEngine = 3;
pub const BtorOptEngine_BTOR_ENGINE_AIGPROP: BtorOptEngine = 4;
pub const BtorOptEngine_BTOR_ENGINE_QUANT: BtorOptEngine = 5;
pub const BtorOptEngine_BTOR_ENGINE_MAX: BtorOptEngine = 6;
pub type BtorOptEngine = u32;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_MIN: BtorOptInputFormat = 0;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_NONE: BtorOptInputFormat = 1;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_BTOR: BtorOptInputFormat = 2;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_BTOR2: BtorOptInputFormat = 3;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_SMT1: BtorOptInputFormat = 4;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_SMT2: BtorOptInputFormat = 5;
pub const BtorOptInputFormat_BTOR_INPUT_FORMAT_MAX: BtorOptInputFormat = 6;
pub type BtorOptInputFormat = u32;
pub const BtorOptOutputBase_BTOR_OUTPUT_BASE_MIN: BtorOptOutputBase = 0;
pub const BtorOptOutputBase_BTOR_OUTPUT_BASE_BIN: BtorOptOutputBase = 1;
pub const BtorOptOutputBase_BTOR_OUTPUT_BASE_HEX: BtorOptOutputBase = 2;
pub const BtorOptOutputBase_BTOR_OUTPUT_BASE_DEC: BtorOptOutputBase = 3;
pub const BtorOptOutputBase_BTOR_OUTPUT_BASE_MAX: BtorOptOutputBase = 4;
pub type BtorOptOutputBase = u32;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_MIN: BtorOptOutputFormat = 0;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_BTOR: BtorOptOutputFormat = 1;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_BTOR2: BtorOptOutputFormat = 2;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_SMT2: BtorOptOutputFormat = 3;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_AIGER_ASCII: BtorOptOutputFormat = 4;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_AIGER_BINARY: BtorOptOutputFormat = 5;
pub const BtorOptOutputFormat_BTOR_OUTPUT_FORMAT_MAX: BtorOptOutputFormat = 6;
pub type BtorOptOutputFormat = u32;
pub const BtorOptDPQsort_BTOR_DP_QSORT_MIN: BtorOptDPQsort = 0;
pub const BtorOptDPQsort_BTOR_DP_QSORT_JUST: BtorOptDPQsort = 1;
pub const BtorOptDPQsort_BTOR_DP_QSORT_ASC: BtorOptDPQsort = 2;
pub const BtorOptDPQsort_BTOR_DP_QSORT_DESC: BtorOptDPQsort = 3;
pub const BtorOptDPQsort_BTOR_DP_QSORT_MAX: BtorOptDPQsort = 4;
pub type BtorOptDPQsort = u32;
pub const BtorOptJustHeur_BTOR_JUST_HEUR_MIN: BtorOptJustHeur = 0;
pub const BtorOptJustHeur_BTOR_JUST_HEUR_BRANCH_LEFT: BtorOptJustHeur = 1;
pub const BtorOptJustHeur_BTOR_JUST_HEUR_BRANCH_MIN_APP: BtorOptJustHeur = 2;
pub const BtorOptJustHeur_BTOR_JUST_HEUR_BRANCH_MIN_DEP: BtorOptJustHeur = 3;
pub const BtorOptJustHeur_BTOR_JUST_HEUR_MAX: BtorOptJustHeur = 4;
pub type BtorOptJustHeur = u32;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_MIN: BtorOptSLSStrat = 0;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_BEST_MOVE: BtorOptSLSStrat = 1;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_RAND_WALK: BtorOptSLSStrat = 2;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_FIRST_BEST_MOVE: BtorOptSLSStrat = 3;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_BEST_SAME_MOVE: BtorOptSLSStrat = 4;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_ALWAYS_PROP: BtorOptSLSStrat = 5;
pub const BtorOptSLSStrat_BTOR_SLS_STRAT_MAX: BtorOptSLSStrat = 6;
pub type BtorOptSLSStrat = u32;
pub const BtorOptPropPathSel_BTOR_PROP_PATH_SEL_MIN: BtorOptPropPathSel = 0;
pub const BtorOptPropPathSel_BTOR_PROP_PATH_SEL_CONTROLLING: BtorOptPropPathSel = 1;
pub const BtorOptPropPathSel_BTOR_PROP_PATH_SEL_ESSENTIAL: BtorOptPropPathSel = 2;
pub const BtorOptPropPathSel_BTOR_PROP_PATH_SEL_RANDOM: BtorOptPropPathSel = 3;
pub const BtorOptPropPathSel_BTOR_PROP_PATH_SEL_MAX: BtorOptPropPathSel = 4;
pub type BtorOptPropPathSel = u32;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_MIN: BtorOptQuantSynth = 0;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_NONE: BtorOptQuantSynth = 1;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_EL: BtorOptQuantSynth = 2;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_ELMC: BtorOptQuantSynth = 3;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_EL_ELMC: BtorOptQuantSynth = 4;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_ELMR: BtorOptQuantSynth = 5;
pub const BtorOptQuantSynth_BTOR_QUANT_SYNTH_MAX: BtorOptQuantSynth = 6;
pub type BtorOptQuantSynth = u32;
pub use self::BtorOptQuantSynth as BtorOptQuantSynt;
pub const BtorOptFunEagerLemmas_BTOR_FUN_EAGER_LEMMAS_MIN: BtorOptFunEagerLemmas = 0;
pub const BtorOptFunEagerLemmas_BTOR_FUN_EAGER_LEMMAS_NONE: BtorOptFunEagerLemmas = 1;
pub const BtorOptFunEagerLemmas_BTOR_FUN_EAGER_LEMMAS_CONF: BtorOptFunEagerLemmas = 2;
pub const BtorOptFunEagerLemmas_BTOR_FUN_EAGER_LEMMAS_ALL: BtorOptFunEagerLemmas = 3;
pub const BtorOptFunEagerLemmas_BTOR_FUN_EAGER_LEMMAS_MAX: BtorOptFunEagerLemmas = 4;
pub type BtorOptFunEagerLemmas = u32;
pub const BtorOptIncrementalSMT1_BTOR_INCREMENTAL_SMT1_MIN: BtorOptIncrementalSMT1 = 0;
pub const BtorOptIncrementalSMT1_BTOR_INCREMENTAL_SMT1_BASIC: BtorOptIncrementalSMT1 = 1;
pub const BtorOptIncrementalSMT1_BTOR_INCREMENTAL_SMT1_CONTINUE: BtorOptIncrementalSMT1 = 2;
pub const BtorOptIncrementalSMT1_BTOR_INCREMENTAL_SMT1_MAX: BtorOptIncrementalSMT1 = 3;
